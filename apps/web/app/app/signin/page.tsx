      ...
      <div className="flex flex-col gap-4 justify-center items-center w-full">
        <div className="flex flex-col gap-2 justify-center items-center text-center py-12 px-20">
          ...
          <p>
            ...
            This allows us to access your Instagram account and manage your
            content.
          </p>
        </div>
        <Form {...form}>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 -my-4">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel>
                      I confirm that I have an <b>Instagram Business</b> or{" "}
                      <b>Creator</b> account
                    </FormLabel>
                    {/* <FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel>
                      I confirm that I have a <b>Facebook page</b> linked to my
                      Instagram account
                    </FormLabel>
                    {/* <FormDescription>
                                        You can manage your mobile notifications in the{" "}
